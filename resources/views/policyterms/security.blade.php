...
<div class="container content">
    ...
    <p class="MsoNormal" style="text-align:justify;">
      1.1. Chào mừng bạn đến với nền tảng mua hàng trực tuyến
      (bao gồm website và ứng dụng di động ) được được vận hành bởi Công ty
      TNHH ABC và các công ty liên kết (gọi riêng và gọi chung là,
      "ABC", "chúng tôi", hay "của chúng tôi").
    </p>
    <p class="MsoNormal" style="text-align:justify;">
    ...
    <p class="MsoNormal" style="margin-left:.5in;text-align:justify;text-indent:-.25in;">
      ●&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      khi bạn liên kết tài khoản với tài
